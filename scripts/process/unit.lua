...
process:onStart(function(this)
    ...
    print(u:modelId(), u:speechAlias(), u:speechExtra())
    bubble.u1 = u
    ...
    print(u:modelId(), u:speechAlias(), u:speechExtra(), u:isImmovable())
    bubble.u4 = u

    -- 建筑形态步兵一个
    u = Player(1):unit(TPL_UNIT.FootmanBuilding, 0, -600, 270)
    print(u:modelId(), u:speechAlias(), u:speechExtra(), u:isImmovable(), u:isBuilding())
    bubble.u5 = u
